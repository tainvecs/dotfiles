...
ZSHRC_INIT_LOCAL_CONFIG_SRC="$DOTFILES_LOCAL/config/zsh/.zshrc_initialize.zsh.local"
ZSHRC_INIT_LOCAL_CONFIG_DST="$DOTFILES_CONFIG/zsh/.zshrc_initialize.zsh.local"
[[ -L $ZSHRC_INIT_LOCAL_CONFIG_DST || -f $ZSHRC_INIT_LOCAL_CONFIG_DST ]] || ln -s $ZSHRC_INIT_LOCAL_CONFIG_SRC $ZSHRC_INIT_LOCAL_CONFIG_DST

ZSHRC_APPS_LOCAL_CONFIG_SRC="$DOTFILES_LOCAL/config/zsh/.zshrc_apps.zsh.local"
ZSHRC_APPS_LOCAL_CONFIG_DST="$DOTFILES_CONFIG/zsh/.zshrc_apps.zsh.local"
[[ -L $ZSHRC_APPS_LOCAL_CONFIG_DST || -f $ZSHRC_APPS_LOCAL_CONFIG_DST ]] || ln -s $ZSHRC_APPS_LOCAL_CONFIG_SRC $ZSHRC_APPS_LOCAL_CONFIG_DST

ZSHRC_PLUGINS_LOCAL_CONFIG_SRC="$DOTFILES_LOCAL/config/zsh/.zshrc_plugins.zsh.local"
ZSHRC_PLUGINS_LOCAL_CONFIG_DST="$DOTFILES_CONFIG/zsh/.zshrc_plugins.zsh.local"
[[ -L $ZSHRC_PLUGINS_LOCAL_CONFIG_DST || -f $ZSHRC_PLUGINS_LOCAL_CONFIG_DST ]] || ln -s $ZSHRC_PLUGINS_LOCAL_CONFIG_SRC $ZSHRC_PLUGINS_LOCAL_CONFIG_DST

ZSHRC_FINAL_LOCAL_CONFIG_SRC="$DOTFILES_LOCAL/config/zsh/.zshrc_finalize.zsh.local"
ZSHRC_FINAL_LOCAL_CONFIG_DST="$DOTFILES_CONFIG/zsh/.zshrc_finalize.zsh.local"
[[ -L $ZSHRC_FINAL_LOCAL_CONFIG_DST || -f $ZSHRC_FINAL_LOCAL_CONFIG_DST ]] || ln -s $ZSHRC_FINAL_LOCAL_CONFIG_SRC $ZSHRC_FINAL_LOCAL_CONFIG_DST
