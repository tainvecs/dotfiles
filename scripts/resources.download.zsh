...
if [[ ! -f "$ITERM_COLORS_DST/Solarized High Contrast Dark.itermcolors" ]]; then
    curl -fL "https://raw.githubusercontent.com/mbadolato/iTerm2-Color-Schemes/master/schemes/Solarized%20Dark%20Higher%20Contrast.itermcolors"\
...
if [[ ! -f "$FONTS_DST/all-the-icons.ttf" ]]; then
    curl -fL "https://github.com/domtronn/all-the-icons.el/blob/master/fonts/all-the-icons.ttf?raw=true" \
         -o "$FONTS_DST/all-the-icons.ttf"
fi

if [[ ! -f "$FONTS_DST/file-icons.ttf" ]]; then
    curl -fL "https://github.com/domtronn/all-the-icons.el/blob/master/fonts/file-icons.ttf?raw=true" \
         -o "$FONTS_DST/file-icons.ttf"
fi

if [[ ! -f "$FONTS_DST/fontawesome.ttf" ]]; then
    curl -fL "https://github.com/domtronn/all-the-icons.el/blob/master/fonts/fontawesome.ttf?raw=true" \
         -o "$FONTS_DST/fontawesome.ttf"
fi

if [[ ! -f "$FONTS_DST/material-design-icons.ttf" ]]; then
    curl -fL "https://github.com/domtronn/all-the-icons.el/blob/master/fonts/material-design-icons.ttf?raw=true" \
         -o "$FONTS_DST/material-design-icons.ttf"
fi

if [[ ! -f "$FONTS_DST/octicons.ttf" ]]; then
    curl -fL "https://github.com/domtronn/all-the-icons.el/blob/master/fonts/octicons.ttf?raw=true" \
         -o "$FONTS_DST/octicons.ttf"
fi

if [[ ! -f "$FONTS_DST/weathericons.ttf" ]]; then
    curl -fL "https://github.com/domtronn/all-the-icons.el/blob/master/fonts/weathericons.ttf?raw=true" \
         -o "$FONTS_DST/weathericons.ttf"
fi

# for iterms
if [[ ! -f "$FONTS_DST/MesloLGS NF Regular.ttf" ]]; then
    curl -fL "https://github.com/romkatv/powerlevel10k-media/blob/master/MesloLGS%20NF%20Regular.ttf?raw=true" \
...
if [[ ! -f "$DELTA_THEME_DST/themes.gitconfig" ]]; then
    ...
    curl -fL "https://raw.githubusercontent.com/dandavison/delta/master/themes.gitconfig" \
...
if [[ ! -f "$VIM_COLORS_DST/desertEx.vim" ]]; then
    curl -fL "https://raw.githubusercontent.com/vim-scripts/desertEx/master/colors/desertEx.vim" \
